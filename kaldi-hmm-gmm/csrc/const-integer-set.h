// kaldi-hmm-gmm/csrc/const-integer-set.h
//
// Copyright (c)  2022  Xiaomi Corporation

// this file is copied and modified from
// kaldi/src/util/const-integer-set.h

#ifndef KALDI_HMM_GMM_CSRC_CONST_INTEGER_SET_H_
#define KALDI_HMM_GMM_CSRC_CONST_INTEGER_SET_H_
#include <algorithm>
#include <cassert>
#include <limits>
#include <set>
...
class ConstIntegerSet {
 ...
 private:
  ...
  std::vector<I> slow_set_;  // sorted
  void InitInternal();
};

}  // namespace khg

#include "kaldi-hmm-gmm/csrc/const-integer-set-inl.h"

#endif  // KALDI_HMM_GMM_CSRC_CONST_INTEGER_SET_H_
