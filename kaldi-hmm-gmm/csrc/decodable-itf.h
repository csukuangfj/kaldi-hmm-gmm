// kaldi-hmm-gmm/csrc/decodable-itf.h
...
// kaldi/src/itf/decodable-itf.h
#ifndef KALDI_HMM_GMM_CSRC_DECODABLE_ITF_H_
#define KALDI_HMM_GMM_CSRC_DECODABLE_ITF_H_
...
class DecodableInterface {
 public:
  ...
  /// available for this decodable object.  This is for use in setups where you
  /// don't want the decoder to block while waiting for input.  This is newly
  /// added as of Jan 2014, and I hope, going forward, to rely on this mechanism
  /// more than IsLastFrame to know when to stop decoding.
  virtual int32_t NumFramesReady() const {
    KHG_ERR << "NumFramesReady() not implemented for this decodable type.";
    return -1;
  }
...
#endif  // KALDI_HMM_GMM_CSRC_DECODABLE_ITF_H_
